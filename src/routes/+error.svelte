...
<svelte:head>
	<title>Error {errorCode} - Family</title>
</svelte:head>
		...
		<div class="bg-white rounded-lg shadow-lg p-8">
			...
			<div class="space-y-3">
				<button
					...
					class="w-full flex items-center justify-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors"
				>
